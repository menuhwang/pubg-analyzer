...
class PubgAPITest {
    ...
    @Test
    void player() {
        Player player = pubgAPI.player("WackyJacky101");
    ...
    @Test
    void multiPlayer() {
        List<String> nicknames = List.of("Patriot_Engineer", "LSWW1", "Mr_POLOO", "ss_barl");
        Set<Player> players = pubgAPI.player(nicknames);
